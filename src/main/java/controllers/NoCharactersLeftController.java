...
public class NoCharactersLeftController extends AbstractController {
    ...
    public NoCharactersLeftController(IAppController appController, Stage primaryStage, URL url, Media media){
